  ...
  return (
    <article className="flex flex-col justify-center px-16 py-20">
      ...
      <footer className="flex items-center gap-4 py-10">
        ...
        <button className="flex items-center justify-center w-full gap-4 py-4 text-white bg-orange-400 rounded-xl hover:bg-orange-300 fill-white">
          <img src={IconCart} alt="icon cart" className='fill-white'/>
